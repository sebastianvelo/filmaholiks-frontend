    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {props.data?.map((item, index) => item && (
                <div
                    key={index}
                    className="backdrop-blur-lg bg-white/5 rounded-lg p-2 md:p-4 hover:bg-white/10 transition-colors border-l-2 border-secondary-500 dark:border-primary-500"
                >
