...
export const getButtonClassName = (active: boolean, inline: boolean) => {
    return Tailwind.builder()
        ...
        .addIf("bg-secondary-100/80 dark:bg-primary-900/20 text-black/90 dark:text-primary-300 border-transparent hover:text-secondary-800 dark:hover:text-primary-200 hover:border-secondary-800 dark:hover:border-primary-200", !active)
