...
export const getButtonClassName = (active: boolean, inline: boolean) => {
    return Tailwind.builder()
        ...
        .addIf("rounded-tr-md rounded-tl-md bg-secondary-200 dark:bg-primary-900/50 font-bold text-secondary-900 dark:text-primary-300 border-secondary-900 dark:border-primary-300", active)
