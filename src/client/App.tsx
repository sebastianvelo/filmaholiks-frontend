...
const App: FunctionComponent = () => {
  ...
  return (
    <div className={`font-sans max-w-screen overflow-x-hidden bg-gradient-to-b from-slate-100 via-white to-slate-100 dark:from-slate-950 dark:via-black dark:to-slate-950`}>
